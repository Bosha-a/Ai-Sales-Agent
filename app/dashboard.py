...
def render_monitoring_dashboard(usage_logs):
    ...
    with tab_user:
        st.dataframe(user_rollup, use_container_width=True, hide_index=True)

    with tab_conversation:
        st.dataframe(conversation_rollup, use_container_width=True, hide_index=True)

    with tab_message:
        st.dataframe(message_rollup, use_container_width=True, hide_index=True)
    ...
    with tab_opt:
        st.markdown("**Applied optimization**")
        st.write(
